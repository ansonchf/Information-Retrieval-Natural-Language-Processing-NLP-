...
with open('CSTwitter.txt', 'r',encoding='utf-8') as shakespeare_read:
...
# Negative lexicon
ndct = ''
with open('bl_opp.csv', 'r', encoding='utf-8', errors='ignore') as infile:
    for line in infile:
        ndct = ndct + line
...
# Positive lexicon
pdct = ''
with open('bl_coop.csv', 'r', encoding='utf-8', errors='ignore') as infile:
    for line in infile:
        pdct = pdct + line
...
plt.savefig("Corbyn&StarmerTwitter.png",format='png',dpi=200)
plt.show()
